 ...
 */
#define USB_CFG_VENDOR_NAME     'a', '9', '8', '.', 's', 'h', 'u', 't', 't', 'l', 'e', '.', 'd', 'e',
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'S', 'u', 'n', ' ', 's', 'e', 'r', 'i', 'a', 'l', ' ', 'k', 'e', 'y', 'b', 'o', 'a', 'r', 'd', 
...
#define USB_CFG_INTERFACE_PROTOCOL  0x01    /* protocol */
/* See USB specification if you want to conform to an existing device class or
 * protocol. The following classes must be set at interface level:
 * HID class is 3, no subclass and protocol required (but may be useful!)
 * CDC class is 2, use subclass 2 and protocol 1 for ACM
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    77  /* total length of report descriptor */
